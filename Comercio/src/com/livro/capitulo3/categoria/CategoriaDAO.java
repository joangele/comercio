		...
		this.transacao.commit();
		   ...
		   try{	
			if (this.sessao.isOpen()){
			  ...
			  System.out.println("Erro ao fechar operacao de exclusao. Erro:" + e.getMessage()); 
		   }
		}
	...
	public Categoria buscaCategoria (Integer codigo) {
		...
		this.transacao.commit();
			...
			try{
				...
				System.out.println("Erro ao fechar operacao de busca");
			}
	 ...
	 this.transacao.commit();
	   ...
	   try{	
		if (this.sessao.isOpen()){
		  ...
		  System.out.println("Erro ao fechar operacao de listagem. Erro: " + e.getMessage());	
		}
